...
console.log("orientation midpoint is: " + rotation_midpoint);
console.log("orientation scale factor is: " + scale_factor_orientation);*/
...
// if in receptive training, then grab radius/orientation values from training values array
...
// randomize order of training blocks
order1_antennas = shuffle(order1_antennas);
...
// create array of training stimuli for Order 2 
for(i = 0; i < num_blocks; i++) {
    var antennas_block = [];
    for(j = 0; j < num_training_trials_block / 2; j++) {
      if(training_condition == "active") {
...
// randomize order of training blocks
order2_antennas = shuffle(order2_antennas);
