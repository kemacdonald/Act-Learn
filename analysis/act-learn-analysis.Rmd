...
block_plot_exp1 <- ggplot(aes(x=as.factor(block), y=mean_accuracy, color = condition), data=ms_block_sequence) +
    geom_pointrange(aes(ymin=mean_accuracy - ci_low, ymax=mean_accuracy + ci_high), size=0.6) +
    geom_hline(yintercept = 0.5, linetype = "dashed") +
...
block_plot2_sequence <- ggplot(aes(x=as.factor(block_factor), y=mean_accuracy, color = condition, group = condition), 
